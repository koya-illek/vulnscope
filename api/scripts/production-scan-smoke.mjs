...
console.log(
  `VulnScope mutating production scan smoke passed at ${baseUrl}: DNS ${report.dns.addresses.length} addresses, main GET measured, grade ${report.summary.grade}, self-scan blocked explicitly.`,
);
