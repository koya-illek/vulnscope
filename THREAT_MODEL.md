...
| Large response or concurrent probe abuse | 46-request hard budget, six concurrent target connections, request-wide deadline, bounded body readers, and phase partial status | IP quotas are bypassable by rotation while the beta remains open |
